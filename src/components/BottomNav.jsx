  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white shadow-lg">
      <div className="flex justify-around max-w-screen-sm mx-auto">
        <NavLink to="/" className={({ isActive }) => `flex flex-col items-center justify-center p-2 hover:text-blue-500 ${isActive ? activeLink : inactiveLink}`}>
        ...
        <NavLink to="/products" className={({ isActive }) => `flex flex-col items-center justify-center p-2 hover:text-blue-500 ${isActive ? activeLink : inactiveLink}`}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256"><path d="M208,40H48A16,16,0,0,0,32,56V200a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V56A16,16,0,0,0,208,40ZM92,116a12,12,0,1,1,12,12A12,12,0,0,1,92,116Zm72,56a12,12,0,1,1,12-12A12,12,0,0,1,164,172Z"></path></svg>
          <span className="text-xs">Products</span>
        </NavLink>

        <NavLink to="/results" className={({ isActive }) => `flex flex-col items-center justify-center p-2 hover:text-blue-500 ${isActive ? activeLink : inactiveLink}`}>
